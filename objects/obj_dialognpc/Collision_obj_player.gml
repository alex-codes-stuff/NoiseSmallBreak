...
if (keyboard_check_pressed(vk_up) && other.state == states.normal)
{
...
{
    draw_set_font(Font2)
    while (scr_string_width(argument0) > ((camera_get_view_width(view_camera[0]) - (rpadding * 2)) - string_width("a")))
    {
